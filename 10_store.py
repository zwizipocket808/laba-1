...
divan_items = store[divan_code]
divan_quantity = divan_items[0]['quantity'] + divan_items[1]['quantity']
divan_cost = divan_items[0]['quantity'] * divan_items[0]['price'] + divan_items[1]['quantity'] * divan_items[1]['price']
